      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            v-model="field.label"
            type="text"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][label]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          ...
          <input
            v-model="field.is_required"
            type="hidden"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][is_required]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          ...
          <input
            v-model="field.type"
            type="hidden"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][type]`"
          >
      ...
      >
        <template #default="{ inputId }">
          ...
          <input
            v-model="field.pt"
            type="hidden"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][pt]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            type="checkbox"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][is_selectable]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            type="checkbox"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][is_number_adjustable]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            step="1"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][default_number]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            :min="1"
            step="1"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][max_number]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          <input
            ...
            :min="1"
            step="1"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][min_number]`"
          >
        </template>
      </jab-field>
      ...
      >
        <template #default="{ inputId }">
          $ <input
            ...
            min="0"
            step="0.01"
            :name="`jab_filters_settings[${filterInstanceIndex}][popup][fields][${fieldIndex}][price]`"
          >
