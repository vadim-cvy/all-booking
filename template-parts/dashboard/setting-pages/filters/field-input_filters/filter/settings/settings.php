...
{ ?>
  <div class="jbk-filter__settings__section">
    <strong class="jbk-filter__settings__section__title">
      <?php echo esc_html( $filter_settings_section_label ); ?> Settings
    </strong>

    <div class="
      jbk-filter__settings__section__content
      jbk-filter__settings_<?php echo esc_attr( $filter_settings_section_name ); ?>
    ">
