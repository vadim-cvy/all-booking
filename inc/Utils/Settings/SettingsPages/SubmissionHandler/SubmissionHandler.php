<?php
namespace Jab\Utils\Settings\SettingsPages\SubmissionHandler;

use Jab\Utils\Settings\SettingsPages\Page;
...
abstract class SubmissionHandler extends \Jab\Utils\DesignPatterns\Singleton implements iHookable
{
  ...
  final protected function __construct()
  {
    ...
    try
    {
      $validated_sanitized_data = $this->validate_sanitize_submitted_data( $this->get_submitted_data() );

      $validated_sanitized_data = $this->apply_filters( 'validate_sanitize_data', $validated_sanitized_data );
    }
    ...
    {
      $this->on_data_valid( $validated_sanitized_data );
    }
  }

  abstract protected function validate_sanitize_submitted_data( array $submitted_data ) : array;

  abstract protected function on_data_valid( array $validated_sanitized_data ) : void;
